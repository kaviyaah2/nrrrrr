...
router.get('/waifu', async(req, res) => {
	var waif = (await axios.get(`https://raw.githubusercontent.com/kavishkaya/endak-tau/main/waifu.json`)).data
...
router.get('/husbu', async(req, res) => {
	var waif = (await axios.get(`https://raw.githubusercontent.com/kavishkaya/endak-tau/main/husbu.json`)).data
	const result = waif[Math.floor(Math.random() * (waif.length))]
	data = await getBuffer(result)
    await fs.writeFileSync(__path +'/tmp/waifu.png', data)
    await res.sendFile(__path +'/tmp/waifu.png')
...
router.get('/loli', async(req, res) => {
	var waif = (await axios.get(`https://raw.githubusercontent.com/kavishkaya/endak-tau/main/loli.json`)).data
	const result = waif[Math.floor(Math.random() * (waif.length))]
	data = await getBuffer(result)
    await fs.writeFileSync(__path +'/tmp/waifu.png', data)
    await res.sendFile(__path +'/tmp/waifu.png')
...
router.get('/milf', async(req, res) => {
	var waif = (await axios.get(`https://raw.githubusercontent.com/kavishkaya/endak-tau/main/milf.json`)).data
	const result = waif[Math.floor(Math.random() * (waif.length))]
	data = await getBuffer(result)
    await fs.writeFileSync(__path +'/tmp/waifu.png', data)
    await res.sendFile(__path +'/tmp/waifu.png')
...
router.get('/cosplay', async(req, res) => {
	var waif = (await axios.get(`https://raw.githubusercontent.com/kavishkaya/endak-tau/main/cosplay.json`)).data
	const result = waif[Math.floor(Math.random() * (waif.length))]
	data = await getBuffer(result)
    await fs.writeFileSync(__path +'/tmp/waifu.png', data)
    await res.sendFile(__path +'/tmp/waifu.png')
